...
![MFCL systems architecture](./screenshots/systems-architecture.png)

### Role-based approval and segregation of duties

![MFCL approval flow](./screenshots/approval-flow.png)

### Grants, federal awards, and SEFA

![MFCL grants and SEFA flow](./screenshots/grants-sefa.png)
